...
namespace Operations.Intermesh.Extensions
{
    ...
    {
        public static IEnumerable<FillTriangleOLD> CoplanarDivideFrom(this FillTriangleOLD fillA, FillTriangleOLD fillB)
        {
            ...
            foreach (var inflectionPoint in inflectionPoints)
            {
                ...
                var fillTriangle = new FillTriangleOLD(a.Point, a.Normal, -1, b.Point, b.Normal, -1, c.Point, c.Normal, -1, fillA.Trace, fillA.Tag);
            ...
            if (intersectionPoints.Length == 3)
            {
                ...
                yield return new FillTriangleOLD(a.Point, a.Normal, -1, b.Point, b.Normal, -1, c.Point, c.Normal, -1, fillA.Trace, fillA.Tag);
            ...
            else
            {
                ...
                {
                    yield return new FillTriangleOLD(startingPoint.Point, startingPoint.Normal, -1, segment.start.Point, segment.start.Normal, -1, segment.end.Point, segment.end.Normal, -1, fillA.Trace, fillA.Tag);
                }
            }
        }
