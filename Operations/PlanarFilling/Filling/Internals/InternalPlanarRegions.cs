...
{
    internal class InternalPlanarRegions : IFillingRegions
    {
        ...
        private IEnumerable<InternalPlanarSegment> GetNonLinkingSegments(IEnumerable<InternalPlanarSegment> matches, InternalPlanarSegment segment)
        {
