...
namespace Operations.Intermesh.Basics
{
    internal class IntermeshTriangle : IIntermeshTriangle
    {
        ...
        public IntermeshSegment AB { get; set; }
        public IntermeshSegment BC { get; set; }
        public IntermeshSegment CA { get; set; }
        ...
        private List<IntermeshSegment> _intersectionSegments = new List<IntermeshSegment>();
